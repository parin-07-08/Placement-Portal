  ...
  <div class="container d-flex justify-content-center align-items-center vh-100">
    <div class="card p-4 border-dark w-100" style="max-width: 450px;">
      ...
      <form @submit.prevent="register">
        <div class="mb-3"><label class="form-label">Company Name</label><input type="text" v-model="form.name" class="form-control" required /></div>
        ...
        <div class="mb-3"><label class="form-label">Website</label><input type="text" v-model="form.website" class="form-control" required /></div>
        <div class="mb-3"><label class="form-label">HR Contact</label><input type="text" v-model="form.hr" class="form-control" required /></div>
...
export default {
  ...
  methods: {
    async register() {
      const res = await api.request("/company/register", "POST", this.form);
